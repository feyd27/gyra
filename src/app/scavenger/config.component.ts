...
export class ConfigComponent implements OnInit {
  ...
  pools = [
    ...
    new PoolPicker (5, 'VoipLanParty Pool 0-100', 'http://voiplanparty.com:8124', 31536000),
    new PoolPicker (6, 'Pool Burstcoin Space 0-100', 'http://pool.burstcoin.space:8124/', 2592000),
